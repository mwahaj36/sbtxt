...
def smart_split(query):
    ...
    # Fallback split removed to protect natural language plot descriptions
    return parts
...
def search(query, filters=None, num_results=10):
    ...
    for intent in all_intents:
        ...
        for doc in results:
            ...
            # Dynamic thresholding relative to the best match for this specific intent
            if raw_sim > (max_sim * 0.95):
    ...
    for m_id, data in aggregated.items():
        ...
        # Asymmetric Weighting: Base score naturally accumulates. No division penalty.
        score = base_score
        ...
        if total_score > 0:
            final_results.append({
                ...
                "math": {
                    ...
                    "coverage": 1.0, # Kept for schema compatibility, no longer used as a penalty
